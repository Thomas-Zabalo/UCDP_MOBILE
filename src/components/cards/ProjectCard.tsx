...
export default function ProjectCard({
    ...
    return (
        ...
        >
            <div
                className="size-20 shrink-0 rounded-[20px] overflow-hidden bg-gray-200 dark:bg-neutral-800 border border-gray-100 dark:border-neutral-700">
                <img
            ...
            {date}
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1">
                        ...
                        />
                        <span
                            className="text-[10px] font-bold text-gray-500 dark:text-neutral-500 uppercase transition-colors">
              {infoLeft}
            </span>
                    </div>
                    <div className="flex items-center gap-1">
